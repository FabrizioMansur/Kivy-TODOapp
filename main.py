...
class ToDoApp(MDApp):
    ...
    def add_todo(self, title, description):
        if title != "" and description != "" and len(title) < 21 and len(description) < 61:
            ...
            Snackbar(text="Title is missing!",
                     snackbar_x="10dp",
                     snackbar_y="10dp",
                     size_hint_y=.08,
            ...
            Snackbar(text="Description is missing!",
                     snackbar_x="10dp",
                     snackbar_y="10dp",
                     size_hint_y=.08,
                     size_hint_x=(Window.width - (dp(10) * 2)) / Window.width,
            ...
            Snackbar(text="Title length should be < 20!",
                     snackbar_x="10dp",
                     snackbar_y="10dp",
                     size_hint_y=.08,
                     size_hint_x=(Window.width - (dp(10) * 2)) / Window.width,
            ...
            Snackbar(text="Description length should be < 60!",
                     snackbar_x="10dp",
                     snackbar_y="10dp",
                     size_hint_y=.08,
                     size_hint_x=(Window.width - (dp(10) * 2)) / Window.width,
